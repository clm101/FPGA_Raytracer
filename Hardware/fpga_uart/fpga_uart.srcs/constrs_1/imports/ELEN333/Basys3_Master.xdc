...
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Q_latch1]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Q_OBUF]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets Q_OBUF_inst_i_3_n_0]
...
#set_property PACKAGE_PIN V2 [get_ports {led_test_in[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[0]}]
#set_property PACKAGE_PIN T3 [get_ports {led_test_in[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[1]}]
#set_property PACKAGE_PIN T2 [get_ports {led_test_in[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[2]}]
#set_property PACKAGE_PIN R3 [get_ports {led_test_in[3]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[3]}]
#set_property PACKAGE_PIN W2 [get_ports {led_test_in[4]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[4]}]
#set_property PACKAGE_PIN U1 [get_ports {led_test_in[5]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[5]}]
#set_property PACKAGE_PIN T1 [get_ports {led_test_in[6]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[6]}]
#set_property PACKAGE_PIN R2 [get_ports {led_test_in[7]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_test_in[7]}]
...
set_property PACKAGE_PIN V13 [get_ports {data_store[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[0]}]
set_property PACKAGE_PIN V3 [get_ports {data_store[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[1]}]
set_property PACKAGE_PIN W3 [get_ports {data_store[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[2]}]
set_property PACKAGE_PIN U3 [get_ports {data_store[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[3]}]
set_property PACKAGE_PIN P3 [get_ports {data_store[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[4]}]
set_property PACKAGE_PIN N3 [get_ports {data_store[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[5]}]
set_property PACKAGE_PIN P1 [get_ports {data_store[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[6]}]
set_property PACKAGE_PIN L1 [get_ports {data_store[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {data_store[7]}]
